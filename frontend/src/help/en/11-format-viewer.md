...
- **JSON** — A structured list of utterances with start time, end time, text, and speaker label. The right choice when you want to process the transcript programmatically. In the refined view, the JSON export contains both the original and the refined utterances as two arrays side by side.
